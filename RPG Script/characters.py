...
avatars= {
    ...
    "green mage": Person(
        name="Gandalf", hp=750, mp=600, atk=80, df=75, speed = 40, mgk_atk=200, mgk_def=90,
        items=[],
    ...
    "wizard": Person(
        name="Snape", hp=680, mp=600, atk=40, df=70, speed = 50, mgk_atk=220, mgk_def=70,
        items=[],
    ...
    "sorcerer": Person(
        name="Vivi", hp=650, mp=600, atk=40, df=70, speed = 60, mgk_atk=200, mgk_def=100,
        items=[],
    ...
    "you": Person(
        name= "You", hp=125, mp=500, atk=100, df=65, speed = 80, mgk_atk=125, mgk_def=80,
        items=[],
        spells=[],
...
allies = {
    ...
    "eldric": Person(
        name="Eldric the Warrior", hp=650, mp=100, atk=120, df=70, speed = 90, mgk_atk=80, mgk_def=60,
        items=[],
        spells=[],
    ...
    "garrick": Person(
        name="Garrick the Guardian", hp=800, mp=80, atk=120, df=100, speed = 40, mgk_atk=35, mgk_def=50,
        items=[],
        spells=[],
