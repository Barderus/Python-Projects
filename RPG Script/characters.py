...
avatars= {
    "fighter": Person(
        name="Aragorn", health=1500, mp=200, atk=200, df=150, mgk_atk=50, mgk_def=100,
        items=[],
        spells=[],
        descri = "A fearless and stalwart protector, the Warrior excels in close combat and defense."
    ),
    "bruiser": Person(
        name="Gimli", health=1800, mp=100, atk=220, df=200, mgk_atk=30, mgk_def=150,
        items=[],
        spells=[],
    ...
    "barbarian": Person(
        name="Conan",
        health=1700, mp=150, atk=210, df=180, mgk_atk=40, mgk_def=120,
        items=[],
        spells=[],
    ...
    "healer": Person(
        name="Aerith",
        health=1200, mp=500, atk=30, df=80, mgk_atk=150, mgk_def=120,
        items=[],
    ...
    "green mage": Person(
        name="Gandalf", health=1400, mp=400, atk=120, df=150, mgk_atk=100, mgk_def=140,
        items=[],
    ...
    "wizard": Person(
        name="Snape",
        health=1100, mp=600, atk=40, df=70, mgk_atk=200, mgk_def=100,
        items=[],
    ...
    "you": Person(
        name= "[You]",
        health=1500, mp=500, atk=50, df=50, mgk_atk=50, mgk_def=50,
        items=[],
        spells=[],
...
allies = {
    "liora": Person(
        name="Liora the Healer", health=450, mp=300, atk=50, df=40, mgk_atk=70, mgk_def=90,
        items=[],
    ...
    "zarek": Person(
        name="Zarek the Black Mage", health=320, mp=450, atk=30, df=35, mgk_atk=95, mgk_def=75,
        items=[],
    ...
    "eldric": Person(
        name="Eldric the Warrior", health=700, mp=100, atk=85, df=70, mgk_atk=20, mgk_def=30,
        items=[],
        spells=[],
        descri="A seasoned warrior known for his unshakable resolve and strength in battle. Eldric excels in close combat."
    ),
    "sylphra": Person(
        name="Sylphra the White Mage", health=400, mp=350, atk=40, df=45, mgk_atk=65, mgk_def=80,
        items=[],
    ...
    "thorn": Person(
        name="Thorne the Dark Blade", health=620, mp=150, atk=90, df=65, mgk_atk=45, mgk_def=55,
        items=[],
        spells=["Dark", "Drain"],
        descri="A warrior with a mastery of dark magic, Thorne strikes fear into the hearts of his enemies with his cursed blade."
    ),
    "faye": Person(
        name="Faye the Mystic", health=380, mp=420, atk=25, df=30, mgk_atk=85, mgk_def=70,
        items=[],
    ...
    "garrick": Person(
        name="Garrick the Guardian", health=800, mp=80, atk=75, df=85, mgk_atk=35, mgk_def=40,
        items=[],
        spells=[],
    ...
    "talia": Person(
        name="Talia the Battle Cleric", health=520, mp=250, atk=60, df=55, mgk_atk=55, mgk_def=65,
        items=[],
...
enemies = {
    # Enemies
    "goblin": Person(
        name="Goblin", health=400, mp=50, atk=70, df=30, mgk_atk=10, mgk_def=20,
        items=[],
        spells=[],
        descri = ""
    ),
    "orc": Person(
        name="Orc", health=400, mp=50, atk=70, df=30, mgk_atk=10, mgk_def=20,
        items=[],
        spells=[],
        descri = ""
    ),
    "kobold": Person(
        name="Kobold", health=400, mp=50, atk=70, df=30, mgk_atk=10, mgk_def=20,
        items=[],
        spells=[],
        descri = ""
    ),
    "skeleton": Person(
        name="Skeleton Warrior", health=400, mp=50, atk=70, df=30, mgk_atk=10, mgk_def=20,
        items=[],
        spells=[],
        descri = ""
    ),
    "knight": Person(
        name="Dark Knight", health=400, mp=50, atk=70, df=30, mgk_atk=10, mgk_def=20,
        items=[],
        spells=[],
        descri = ""
    ),
    "ghoul": Person(
        name="Ghoul", health=400, mp=50, atk=70, df=30, mgk_atk=10, mgk_def=20,
        items=[],
        spells=[],
        descri = ""
    ),
    "slime": Person(
        name="Slime", health=400, mp=50, atk=70, df=30, mgk_atk=10, mgk_def=20,
        items=[],
        spells=[],
        descri = ""
    ),
    "necro": Person(
        name="Necromancer", health=400, mp=50, atk=70, df=30, mgk_atk=10, mgk_def=20,
        items=[],
        spells=[],
        descri = ""
    ),
    "ghost": Person(
        name="Wraith", health=400, mp=50, atk=70, df=30, mgk_atk=10, mgk_def=20,
        items=[],
        spells=[],
        descri = ""
    ),
    "troll": Person(
        name="Troll", health=400, mp=50, atk=70, df=30, mgk_atk=10, mgk_def=20,
        items=[],
        spells=[],
        descri = ""
    ),
...
bosses = {
    "dragon": Person(
        name="Ur-Dragon", health=400, mp=50, atk=70, df=30, mgk_atk=10, mgk_def=20,
        items=[],
        spells=[],
        descri = ""
    ),
    "lich": Person(
        name="Lich", health=400, mp=50, atk=70, df=30, mgk_atk=10, mgk_def=20,
        items=[],
        spells=[],
        descri = ""
    ),
    "demon": Person(
        name="Orcus", health=400, mp=50, atk=70, df=30, mgk_atk=10, mgk_def=20,
        items=[],
        spells=[],
        descri = ""
    )
